 ...
 */
@interface FFBRequest : NSObject<NSURLConnectionDelegate> {
  __unsafe_unretained id<FBRequestDelegate> _delegate;
  NSString*             _url;
 ...
 */
- (void)requestLoading:(FFBRequest *)request;
 ...
 */
- (void)request:(FFBRequest *)request didLoadRawResponse:(NSData *)data;
