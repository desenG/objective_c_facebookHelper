...
+ (FFBRequest *)getRequestWithParams:(NSMutableDictionary *) params
                         httpMethod:(NSString *) httpMethod
                           delegate:(id<FBRequestDelegate>) delegate
                         requestURL:(NSString *) url {

  //orlyn FBRequest* request = [[[FBRequest alloc] init] autorelease];
  FFBRequest* request = [[FFBRequest alloc] init];
...
- (id)parseJsonResponse:(NSData *)data error:(NSError **)error {
  ...
  */
  ...
  //orlyn SBJSON *jsonParser = [[SBJSON new] autorelease];
...
- (void)connectionDidFinishLoading:(NSURLConnection *)connection {
 ...
 //orlyn [_responseText release];
  _responseText = nil;
 //orlyn [_connection release];
  _connection = nil;
}
