...
- (id)init {
  if (self = [super initWithFrame:CGRectZero]) {
    ...
    //orlyn _closeButton = [[UIButton buttonWithType:UIButtonTypeCustom] retain];
...
- (id)initWithURL: (NSString *) serverURL
  ...
  self = [self init];
  //orlyn _serverURL = [serverURL retain];
    _serverURL = serverURL;
    
  //orlyn _params = [params retain];
    _params = params;
  _delegate = delegate;
...
- (void)loadURL:(NSString*)url get:(NSDictionary*)getParams {
 ...
 //orlyn [_loadingURL release];
 //orlyn _loadingURL = [[self generateURL:url params:getParams] retain];
